...
architecture_config = [ # (kernel size, num_filters, stride, padding) 
    ...
    [(1,256,1,0), (3,512,1,1),4], # Want to repeat sequentially
    (1,512,1,0),
    (3,1024,1,1),
    "M",
    ...
    def create_conv_layers(self, architecture):
        ...
        for x in architecture:
            ...
            if type(x) == tuple :
                ...
                conv1 = x[0] # First layer Tuple
                conv2 = x[1] # Second layer Tuple 
                num_repeats = x[2]
                ...
                for _ in range(num_repeats):
                    ...
                    in_channels = conv2[1]  # For next time in_channels
        
        return nn.Sequential(*layers) # Important
...
def test(S = 7, B = 2, C = 20):
    ...
    print(model(x).shape) # [2, 1470] 1470 = 7*7*30 
test()